...
export const ExpenseListPaginationMetaSchema = z
  .object({
    ...
    totalItems: z.number().int().meta({
      description: 'Total number of transactions that matched the active filters.',
      example: 24,
    }),
  ...
  .meta({ id: 'ExpenseListPaginationMeta' });

export class ExpenseListPaginationMetaDto extends createZodDto(
  ExpenseListPaginationMetaSchema,
) {}
