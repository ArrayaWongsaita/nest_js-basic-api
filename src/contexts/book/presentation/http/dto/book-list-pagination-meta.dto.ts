...
export const BookListPaginationMetaSchema = z
  .object({
    ...
    totalItems: z.number().int().meta({
      description: 'Total number of books that matched the active filters.',
      example: 24,
    }),
  ...
  .meta({ id: 'BookListPaginationMeta' });

export class BookListPaginationMetaDto extends createZodDto(
  BookListPaginationMetaSchema,
) {}
