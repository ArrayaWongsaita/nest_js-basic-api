...
export const ContactListPaginationMetaSchema = z
  .object({
    ...
    totalItems: z.number().int().meta({
      description:
        'Total number of contacts that matched the active filters.',
      example: 24,
    }),
  ...
  .meta({ id: 'ContactListPaginationMeta' });

export class ContactListPaginationMetaDto extends createZodDto(
  ContactListPaginationMetaSchema,
) {}
