...
-- CreateEnum
CREATE TYPE "MovieStatus" AS ENUM ('TO_WATCH', 'WATCHING', 'WATCHED');
...
-- CreateEnum
CREATE TYPE "JobApplicationStatus" AS ENUM ('SAVED', 'APPLIED', 'INTERVIEWING', 'OFFERED', 'REJECTED', 'WITHDRAWN');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('SHORT_TEXT', 'TRUE_FALSE');
...
-- CreateIndex
CREATE INDEX "Order_userId_orderedAt_idx" ON "Order"("userId", "orderedAt");
