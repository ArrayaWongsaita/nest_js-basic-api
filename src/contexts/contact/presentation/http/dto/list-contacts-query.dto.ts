...
export const ListContactsQuerySchema = z
  .object({
    search: z
      ...
      .meta({
        description:
          'Optional case-insensitive text filter applied to the contact first name, last name, email, phone, and company.',
        example: 'john',
      }),
  ...
  .meta({ id: 'ListContactsQuery' });

export class ListContactsQueryDto extends createZodDto(
