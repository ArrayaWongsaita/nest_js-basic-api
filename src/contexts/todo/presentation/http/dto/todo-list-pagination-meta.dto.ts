...
export const TodoListPaginationMetaSchema = z
  .object({
    ...
    totalItems: z.number().int().meta({
      description: 'Total number of todo items that matched the active filters.',
      example: 24,
    }),
  ...
  .meta({ id: 'TodoListPaginationMeta' });

export class TodoListPaginationMetaDto extends createZodDto(
  TodoListPaginationMetaSchema,
) {}
